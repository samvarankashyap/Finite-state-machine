...
# the following test case is not valid so modified 5th line ~ changed the argument for add_final_state("s 3")	
    def test_add_invalid_final_state():
        """ Should raise an exception """
        sm1 = StateMachine.StateMachine()
        try:
            sm1.add_final_state("S 2")
    ...
    def test_add_multiple_final_states():
        ...
        pass
# the folllowing function is wrong ----> channged  sm1.add_final_state("S1", "S3") ~  sm1.add_final_states("S1", "S3")
